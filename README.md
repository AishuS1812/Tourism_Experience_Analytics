...
This project is an interactive Streamlit application designed to analyze a tourism dataset and provide data-driven insights.
...
Automatic merging of multiple sheets from the tourism dataset 

Normalization and renaming of columns 
...
Model performance metrics: MSE, RMSE, R², Accuracy, F1
...
EDA: Histograms, bar charts, heatmaps

Regression: RMSE, MSE, R² values for rating prediction

Classification: Accuracy & weighted F1-score

Recommendation: Top-5 personalized attraction suggestions
...
Recommendation system supported by Surprise library
